import profilePic from "../assets/myProfilePic.webp"
...
const childVariants = {
    hidden: { opacity: 0, x: -100},
    visible: { opacity: 1, x: 0, transition: { duraction: 0.5 }}
}
const Hero = () => {
  return (
        ...
        <div className="flex flex-wrap lg:flex-row-reverse">
            <div className="w-full lg:w-1/2">                
                <div className="flex justify-center lg:p-8">
                    <motion.div className="crt-scanlines"
            ...
            <div className="w-full lg:w-1/2">
                <motion.div 
                    ...
                    <motion.h2
                        ...
                        className="pb-2 text-4xl tracking-tigther lg:text-8xl">
                        Steven Pacheco
                    </motion.h2>
                    <motion.span 
                    variants={childVariants}
                    ...
                    href="/public/myResume.pdf"
                        ...
                        download
                        className="bg-green-700 rounded-full p-4 text-sm
                        text-stone-300 mb-10">
                            Download Resume
                        </motion.a>
                </motion.div>
            </div>
